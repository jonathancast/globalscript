...
\begin{itemize}
    \item \defn{Type synonyms} can be used to give shorter names to a type:
        \begin{haskell} \type t \alpha_0 \ldots \alpha_n = \tau[\alpha_0, \ldots, \alpha_n]; \end{haskell}
...
\begin{itemize}
    ...
    \item \defn{Un-lifted Un-Boxed Product Types}
        ...
        \begin{haskell} \cruprod\crgroup{ \overline{v = e_v}; } :: \cruprod\crgroup{ \overline{v :: \tau_v;} }\end{haskell}

        \begin{haskell} \for \cruprod\crgroup{ \overline{v = x_v;} } = e_0. e_1 \end{haskell}
