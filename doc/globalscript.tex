...
The judgment form for a variable \<v\> in type environment \<\Delta,\Gamma\> is
\begin{equation}\label{eqn:var-judgment}
    \Delta,\Gamma \sequent v :: \overline{\tau_i :: \kappa_i}_{i=0}^{n-1}; \overline{a_j :: \tau_j}_{j=n}^{n+m-1}; \tau
\end{equation}.
\begin{itemize}
