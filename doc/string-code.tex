...
\new{0.5}{in imperative block statemetns, this had to be put out in a \stringcode{.closure} and the result returned.}
...
{
    static gsinterned_string gssymlfield, gssymundefined, gssymlifted, gssymcast, gssymapply;

    int i;

    if (gssymceq(p->directive, gssymlfield, gssymcodeop, ".lfield")) {
