...
{
    static gsinterned_string gssymyield, gssymenter, gssymubprim, gssymlprim, gsssymanalyze, gsssymdanalyze;

    if (gssymceq(parsedline->directive, gssymyield, gssymcodeop, ".yield")) {
