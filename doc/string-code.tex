...
This binds \stringcode{x} to the image of \stringcode{y} under the unit of the lifting monad.
...
{
    static gsinterned_string gssymcast, gssymapply;

    if (gssymceq(p->directive, gssymcast, gssymcodeop, ".cast")) {
