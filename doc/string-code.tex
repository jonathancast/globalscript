...
{
    static gsinterned_string gssymtyref, gssymtysum, gssymtyubsum, gssymtyproduct, gssymtyubproduct;

    while ((n = gsgrabline(pos, chan, line, fields)) > 0) {
        if (gssymceq(parsedline->directive, gssymtyref, gssymtypeop, ".tyref")) {
            if (*fields[0])
