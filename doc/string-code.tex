...
\begin{itemize}
    ...
    \item String constants and character constants are un-quoted and may contain the standard C escapes as well as
        ...
        \old{0.1}{we also had an escape \stringcode{\bs{}h}, which represents a \stringcode{\#} character.}
...
\section{\stringcode{.tyapp}}

This is kind of silly.
In fact, I doubt it's ever used.
Find out.
...
gsparse_data_item(struct gsparse_input_pos *pos, int is_ags, gsparsedfile *parsedfile, struct uxio_ichannel *chan, char *line, char **fields, ulong numfields, struct gsfile_symtable *symtable)
{
    ...
    if (gssymceq(parsedline->directive, gssymtyapp, gssymdatadirective, "")) {
        if (numfields < 2+0+1)
