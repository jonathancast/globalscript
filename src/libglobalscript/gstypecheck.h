...
int gsbc_typecheck_find_constr(struct gspos, int, struct gstype_sum *, gsinterned_string);
...
int gstypes_kind_check(struct gspos, struct gskind *, struct gskind *, struct gsstringbuilder *);
